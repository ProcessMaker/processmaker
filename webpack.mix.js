...
mix.js('resources/js/app-layout.js', 'public/js')
  ...
  .js('resources/js/processes/datasources/index.js', 'public/js/processes/datasources')
  .js('resources/js/processes/datasources/edit.js', 'public/js/processes/datasources')
  .js('resources/js/processes/datasources/config.js', 'public/js/processes/datasources')
