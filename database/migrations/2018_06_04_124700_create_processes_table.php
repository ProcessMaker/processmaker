...
class CreateProcessesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('processes', function (Blueprint $table) {
            ...
            $table->integer('create_script_id')->nullable()->unsigned();
            $table->integer('open_script_id')->nullable()->unsigned();
            $table->integer('deleted_script_id')->nullable()->unsigned();
            $table->integer('canceled_script_id')->nullable()->unsigned();
            $table->integer('paused_script_id')->nullable()->unsigned();
            $table->integer('reassigned_script_id')->nullable()->unsigned();
            $table->integer('unpaused_script_id')->nullable()->unsigned();
