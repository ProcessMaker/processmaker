...
class CreateProcessesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('processes', function (Blueprint $table) {
            ...
            $table->integer('create_trigger_id')->nullable()->unsigned();
            $table->integer('open_trigger_id')->nullable()->unsigned();
            $table->integer('deleted_trigger_id')->nullable()->unsigned();
            $table->integer('canceled_trigger_id')->nullable()->unsigned();
            $table->integer('paused_trigger_id')->nullable()->unsigned();
            $table->integer('reassigned_trigger_id')->nullable()->unsigned();
            $table->integer('unpaused_trigger_id')->nullable()->unsigned();
