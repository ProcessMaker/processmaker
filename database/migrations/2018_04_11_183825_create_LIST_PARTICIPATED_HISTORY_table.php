...
class CreateLISTPARTICIPATEDHISTORYTable extends Migration {
	...
	public function up()
	{
		Schema::create('LIST_PARTICIPATED_HISTORY', function(Blueprint $table)
		{
	...
	{
		Schema::drop('LIST_PARTICIPATED_HISTORY');
	}
