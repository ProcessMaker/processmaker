...
class ScreenCompiledManagerTest extends TestCase
{
     ...
     * @test
     */
    public function test_it_stores_compiled_content(): void
    {
        // Arrange
     ...
     * @test
     */
    public function test_it_retrieves_compiled_content(): void
    {
        // Arrange content
        $manager = new ScreenCompiledManager();
        $screenKey = 'test_screen_key';
     ...
     * @test
     */
    public function test_it_returns_null_when_compiled_content_does_not_exist(): void
    {
        // Arrange
        $manager = new ScreenCompiledManager();
     ...
     * @test
     */
    public function test_it_clears_all_compiled_assets(): void
    {
        // Arrange content
        $manager = new ScreenCompiledManager();
        $screenKey = 'test_screen_key';
     ...
     * @test
     */
    public function test_it_clears_process_screens_cache(): void
    {
        // Arrange
        $manager = new ScreenCompiledManager();
        $processId = '123';
     ...
     * @test
     */
    public function test_it_creates_a_screen_key_with_various_versions(): void
    {
        // Arrange
        $manager = new ScreenCompiledManager();
        $processId = '123';
     ...
     * @test
     */
    public function test_it_gets_the_last_screen_version_id(): void
    {
        // Create the manager
        $manager = new ScreenCompiledManager();
        $expectedId = 999;
     ...
     * @test
     */
    public function test_it_stores_empty_compiled_content(): void
    {
        // Arrange
        $manager = new ScreenCompiledManager();
     ...
     * @test
     */
    public function test_it_handles_storage_exceptions(): void
    {
        // Arrange
        $manager = new ScreenCompiledManager();
     ...
     * @test
     */
    public function test_it_clears_compiled_assets_when_directory_does_not_exist(): void
    {
        // Arrange
        $manager = new ScreenCompiledManager();
     ...
     * @test
     */
    public function test_it_fails_with_invalid_screen_key(): void
    {
        // Arrange
        $manager = new ScreenCompiledManager();
     ...
     * @test
     */
    public function test_it_handles_storage_limit_scenarios(): void
    {
        // Arrange
        $manager = new ScreenCompiledManager();
     ...
     * @test
     */
    public function test_it_deletes_screen_compiled_content(): void
    {
        // Arrange
        $manager = new ScreenCompiledManager();
        $screenId = '5';
     ...
     * @test
     */
    public function test_it_returns_false_when_no_files_match_delete_pattern(): void
    {
        // Arrange
        $manager = new ScreenCompiledManager();
        $screenId = '5';
     ...
     * @test
     */
    public function test_it_handles_special_characters_in_language_code(): void
    {
        // Arrange
        $manager = new ScreenCompiledManager();
        $screenId = '5';
