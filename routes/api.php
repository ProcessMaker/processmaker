...
Route::middleware('auth:api', 'setlocale', 'bindings', 'sanitize')->prefix('api/1.0')->name('api.')->group(function () {
    ...
    Route::get('users/{user}/get_filter_configuration/{name}', [UserController::class, 'getFilterConfiguration'])->name('users.getFilterConfiguration');
    ...
    Route::put('users/{user}/store_filter_configuration/{name}', [UserController::class, 'storeFilterConfiguration'])->name('users.storeFilterConfiguration');
