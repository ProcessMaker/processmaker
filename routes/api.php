...
Route::middleware('auth:api', 'setlocale', 'bindings', 'sanitize')->prefix('api/1.0')->name('api.')->group(function () {
    ...
    Route::get('data-source-integrations/company-details', [DataSourceIntegrationsController::class, 'fetchCompanyDetails'])->name('data-source-integrations.company-details');
});
