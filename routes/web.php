...
Route::group(['middleware' => ['auth', 'sanitize', 'external.connection']], function () {
    ...
    Route::namespace('Process')->prefix('designer')->group(function () {
        ...
        Route::get('datasources', 'DatasourceController@index')->name('package.datasource.index')->middleware('can:view-datasources');
        Route::get('datasources/{datasource}/edit', 'DatasourceController@edit')->name('package.datasource.edit')->middleware('can:edit-datasources');
