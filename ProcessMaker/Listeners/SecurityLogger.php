...
class SecurityLogger
{
    private $eventTypes = [
        ...
        'ProcessMaker\Events\AuthClientUpdated' => 'authClientUpdated',
        'ProcessMaker\Events\AuthClientCreated' => 'authClientCreated',
        'ProcessMaker\Events\AuthClientDeleted' => 'authClientDeleted'
    ];
