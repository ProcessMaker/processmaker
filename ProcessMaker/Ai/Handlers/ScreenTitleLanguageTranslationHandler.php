...
class ScreenTitleLanguageTranslationHandler extends OpenAiHandler
{
    ...
    public function generatePrompt(String $type = null, String $string) : Object
    {
        $prompt = $this->getPromptFile($type);
        $prompt = $this->replaceString($prompt, $string);
    ...
    public function replaceString($prompt, $json_list)
    {
        $replaced = str_replace('{replaceString}', $json_list . " \n", $prompt);
