...
/**
 * Install command handles installing a fresh copy of ProcessMaker Processmaker.
...
class Install extends Command
{
     ...
     * @var string
     */
    protected $description = 'Install and configure ProcessMaker Processmaker';
    ...
    /**
     * Installs a fresh copy of ProcessMaker Processmaker
     *
    ...
    public function handle()
    {
        ...
        $this->env = [
            'APP_DEBUG' => 'FALSE',
            'APP_NAME' => '"ProcessMaker Processmaker"',
            'APP_ENV' => 'production',
            'APP_KEY' => $this->key,
        ...
        $this->info("<fg=cyan;bold>" . __("ProcessMaker Processmaker Installer") . "</>");
        ...
        $this->info(__("This application installs a new version of ProcessMaker Processmaker."));
        ...
        do {
            ...
            $this->env['APP_URL'] = $this->ask(__('What is the URL of this ProcessMaker Processmaker installation? (Ex: https://processmaker.example.com, with no trailing slash)'));
        ...
        $this->info(__("Installing ProcessMaker Processmaker database, OAuth SSL keys and configuration file."));
        ...
        $this->info(__("ProcessMaker Processmaker database installed successfully."));
        ...
        $this->info(__("ProcessMaker Processmaker installation is complete. Please visit the URL in your browser to continue."));
        $this->info(__("Installer completed. Consult ProcessMaker Processmaker documentation on how to configure email, jobs and notifications."));
        return true;
    }


    /**
     * The following checks for required extensions needed by ProcessMaker Processmaker
     */
    ...
    {
        $this->info(__('ProcessMaker Processmaker requires a MySQL database.'));
