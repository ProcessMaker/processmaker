...
class ProcessController extends Controller
{
    ...
    public function update(Request $request, Process $process)
    {
        ...
        $process->fill($request->except('user_id', 'notifications', 'task_notifications', 'notification_settings', 'cancel_request', 'cancel_request_id', 'start_request_id', 'edit_data', 'edit_data_id'));
