---
description: >-
  Add a Submit Button control from which the user can submit a form as part of a
  Request.
---
...
3. Drag the **Submit Button** icon ![](../../../../.gitbook/assets/submit-button-control-screens-builder-processes.png) from the **Controls** panel to the ProcessMaker Screen page.
