       ...
       <div class="col">
        ...
        <div class="col">
          ...
          <select id="inputState" v-model="data.state" class="form-control">
            ...
            <option :key="code" :selected="code == data.state" v-for="(state, code) in states" :value="code">{{state}}</option>
          </select>
        </div>
      </div>
     <div class="row form-group">
       <div class="col">
        ...
        <div class="col">
          ...
          <select id="inputState" v-model="data.country" class="form-control">
            ...
            <option v-for="country in countries" :key="country.abbreviation" :value="country.abbreviation" :selected="data.country == country.abbreviation">{{country.country}}</option>
          </select>
        </div>
      </div>
     <div class="row form-group">
       ...
       <div class="col">
         ...
         <select id="inputTimezone" class="form-control">
           ...
           <option v-for="(zone, index) in timezones" :key="index" :value="zone.abbr" :selected="data.time_zone == zone.abbr">{{zone.text}}</option>
         </select>
       </div>
      </div>
     <div class="row form-group">
