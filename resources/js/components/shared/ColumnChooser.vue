<template>
  ...
  >
    ...
    <div>
      ...
      <div
        ref="columnContainer"
        class="d-flex flex-row align-content-stretch"
      >
        ...
        <div class="column-container w-50">
          ...
          <draggable
            v-else-if="availableColumnsDirect === null || availableColumnsDirect === undefined || (availableColumnsDirect && availableColumnsDirect.length === 0)"
            group="columns"
...
export default {
  ...
  methods: {
    ...
    resizeColumnTabPane() {
      const { top } = document.querySelector(".tab-content").getBoundingClientRect();
