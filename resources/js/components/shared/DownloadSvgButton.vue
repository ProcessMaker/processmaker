<template>
  <div>
    ...
    <!-- Page -->
    <div
      id="modelPrintSection"
      ref="modelPrintSection"
      style="
        display: none;
        position: relative;
        color: #000;
    ...
    >
      ...
      >
        <div
          ...
          style="min-height: 45em;padding: 3em 0 3em 0;"
        >
          <img
            :src="modelImg"
            :alt="title"
        ...
        <div>
          <h5>
            <img
              ...
              style="height: 30px;"
              class="mr-1"
            ><b>Powered By ProcessMaker AI</b>
          </h5>
        </div>
        <div class="d-flex justify-items-between">
          <div class="w-50 text-muted">
            <small>Process Model Autogenerated by ProcessMaker AI {{ requestDate }}</small>
          </div>
          <div class="w-50 text-muted text-right">
            <small>Generate your own process map at <span class="text-primary">https://processmaker.com/ai</span></small>
          </div>
        </div>
      </div>
      ...
      >
        <div
          class="w-50 p-3"
          style="background: #E5F1FF; border-radius: 8px 0 0 8px"
        >
          <h5><b>{{ title }}</b></h5>
        </div>
        <div
          class="w-50 p-3 text-muted"
