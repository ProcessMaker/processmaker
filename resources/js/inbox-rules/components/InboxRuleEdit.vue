  ...
  <div class="pm-inbox-rule-edit">
    <template v-if="viewIs('main')">
      <b-form-group>
        ...
        <b-form-checkbox v-model="markAsPriority">
          <img
            src="/img/flag-fill-red.svg"
            :alt="$t('Mark as Priority')"
          >
          {{ $t('Mark as Priority') }}
        </b-form-checkbox>
        <b-form-checkbox
        ...
        >
          <img
            src="/img/pencil-fill-text.svg"
            :alt="$t('Save and reuse filled data')"
          >
      ...
      <b-form-group>
        ...
        <b-form-checkbox
          v-model="applyToCurrentInboxMatchingTasks"
          value="true"
      ...
      <b-form-group>
        ...
        <b-input-group class="pm-datetime-picker">
          <b-form-input
            v-model="visibleFormattedDeactivationDate"
            type="text"
            autocomplete="off"
            readonly
          ...
          <b-input-group-append>
            ...
            >
              <template #button-content>
                <img
                  src="/img/calendar2-fill.svg"
                  :alt="$t('Deactivation date')"
                >
              </template>
            </b-form-datepicker>
          </b-input-group-append>
      ...
      <b-form-group>
        <div class="pm-inbox-rule-edit-custom-separator" />
      </b-form-group>
    ...
    <template v-if="viewIs('nextConfiguration')">
      ...
      <b-form-group v-if="submitAfterFilling">
        ...
        <b-form-input
          ...
          :placeholder="$t('Waiting for selection')"
          autocomplete="off"
    ...
    >
      <div class="pm-inbox-rule-edit-modal-content mb-4 mr-4 ml-4">
        <img
          src="/img/check-circle-lg.svg"
          :alt="$t('Rule successfully created')"
        >
