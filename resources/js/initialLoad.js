...
import ModelerScreenSelect from "./processes/modeler/components/inspector/ScreenSelect.vue";
import UserSelect from "./processes/modeler/components/inspector/UserSelect.vue";
import GroupSelect from "./processes/modeler/components/inspector/GroupSelect.vue";
import UserById from "./processes/modeler/components/inspector/UserById.vue";
import TaskNotifications from "./processes/modeler/components/inspector/TaskNotifications.vue";
import ExpressionEditor from "./processes/modeler/components/inspector/ExpressionEditor.vue";
import TaskAssignment from "./processes/modeler/components/inspector/TaskAssignment.vue";
import TaskDueIn from "./processes/modeler/components/inspector/TaskDueIn.vue";
import GatewayFlowVariable from "./processes/modeler/components/inspector/GatewayFlowVariable.vue";
import ConfigEditor from "./processes/modeler/components/inspector/ConfigEditor.vue";
import SignalPayload from "./processes/modeler/components/inspector/SignalPayload.vue";
import ScriptSelect from "./processes/modeler/components/inspector/ScriptSelect.vue";
import StartPermission from "./processes/modeler/components/inspector/StartPermission.vue";
import Interstitial from "./processes/modeler/components/inspector/Interstitial.vue";
import SelectUserGroup from "./components/SelectUserGroup.vue";
import validateScreenRef from "./processes/modeler/validateScreenRef";
import validateFlowGenieRef from "./processes/modeler/validateFlowGenieRef";
import ErrorHandlingTimeout from "./processes/modeler/components/inspector/ErrorHandlingTimeout.vue";
