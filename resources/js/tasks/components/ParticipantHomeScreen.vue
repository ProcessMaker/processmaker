                ...
                <div class="tab-pane fade show active" id="inbox" role="tabpanel" aria-labelledby="inbox-tab">
                    ...
                    <div id="search-bar" class="search advanced-search mb-2">
                        ...
                        <div class="flex-grow-1">
                            ...
                            :param-status="status"
                            :permission="userPermissions.hasPermissionsForUsersGroups"
                            ...
                            <template v-slot:left-buttons>
                                ...
                                <div class="d-flex mr-1" v-for="addition in additions">
                                    <component class="d-flex" :is="addition" :permission="userPermissions.hasPermissionsForUsersGroups"></component>
                                </div>
                                </div>
                            </template>
                            ...
                            <template v-slot:right-buttons>
                                ...
                                <b-popover target="idPopoverInboxRules"
                                    ...
                                    <div>
                                        <img src="/img/inbox-rule-suggest.svg" :alt="$t('Inbox Rules')">
                                    </div>
                                    <span class="task-inbox-rules-content-text" v-html="$t('Inbox Rules act as your personal task manager. You tell them what to look for, and they <strong>take care of things automatically.</strong>')">
                                    </span>
                                    </div>
                                </b-popover>
                                <b-button
                                    v-if="userPermissions.isAdministrator || userPermissions.canEditScreens"
                                    class="ml-md-2"
