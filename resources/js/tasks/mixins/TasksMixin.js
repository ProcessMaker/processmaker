export default {
    ...
    computed: {
      effectiveSavedsearchDefaultsEditRoute() {
        return this.savedsearchDefaultsEditRoute || window.ProcessMaker.savedsearchDefaultsEditRoute
      }
    },
    methods: {
      defineUserConfiguration() {
          this.localUserConfiguration = JSON.parse(window.ProcessMaker.userConfiguration || '{}');
