<template>
    <div class="mb-2">
        ...
        <div>
            ...
            <p><span class="font-weight-bold">All</span> Screens will be included in this export.</p>
            </div>
            <div v-else>
            <h6>Export Status:
            <b-badge
            ...
            <p>All Screens will <span class="font-weight-bold">not</span> be included in this export.</p>
            </div>
        </div>
