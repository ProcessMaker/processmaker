<template>
  <div class="data-table">
    ...
    <div v-show="!shouldShowLoader"  class="card card-body table-card">
      ...
      >
        <template slot="name" slot-scope="props">{{props.rowData.name}} <i tabindex="0" v-if="props.rowData.warnings" v-b-tooltip :title="$t('BPMN validation issues. Request cannot be started.')" class="text-warning fa fa-exclamation-triangle"></i></template>
