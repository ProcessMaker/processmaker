<template>
  ...
  >
    ...
    >
      ...
      >
        <span class="fa-li">
          <i :class="item.success ? 'fas fa-check text-success' : 'fas fa-times text-danger'" />
        </span>
    ...
    >
      ...
      <div>
        <span class="card-text"><strong /></span>
          ...
          <tbody>
            ...
            >
              <td class="assignable-name text-right">
                ...
                <i class="assignable-arrow fas fa-long-arrow-alt-right" />
              </td>
              <td
                v-if="item.type === 'webentryCustomRoute'"
                class="assinable-entity"
              >
                <b-input
                  v-model="item.value"
                  :class="{'is-invalid': item.error }"
                  @change="checkForExistingRoute(item)"
                />
                <div
                  v-if="item.error"
                  ...
                  role="alert"
                >
                  <div v-html="item.error" />
                </div>
              </td>
              <td
                v-else
                class="assignable-entity"
              >
                <label
                  for="search-task-text"
                  class="d-none"
                >{{ $t('Type to search task') }}</label>
                <multiselect
                  id="search-task-text"
                  v-model="item.value"
                ...
                <label
                  for="search-user-text"
                  class="d-none"
                >{{ $t('Type to search a user') }}</label>
                <multiselect
                  id="search-user-text"
                  v-model="item.value"
                ...
                <label
                  for="search-script-text"
                  class="d-none"
                >{{ $t('Type to search a script') }}</label>
                <multiselect
                  id="search-script-text"
                  v-model="item.value"
                ...
                <label
                  for="search-user-text"
                  class="d-none"
                >{{ $t('Type to search a process') }}</label>
                <multiselect
                  id="search-user-text"
                  v-model="item.value"
            ...
            <tr>
              ...
              <td class="assignable-entity">
                <label
                  for="search-user-groups-text"
                  class="d-none"
                >{{ $t('Type to search') }}</label>
                <multiselect
                  id="search-user-groups-text"
            ...
            <tr>
              ...
              <td class="assignable-entity">
                <label
                  for="search-user-groups-text-assing"
                  class="d-none"
                >{{ $t('Type to search') }}</label>
                <multiselect
                  id="search-user-groups-text-assing"
            ...
            <tr>
              ...
              <td class="assignable-entity">
                <label
                  for="search-status-text"
                  class="d-none"
                >{{ $t('Type to search status') }}</label>
                <select-status
                  v-model="status"
                  :multiple="false"
                />
  ...
  methods: {
    ...
    loadUsersAndGroups(filter, users, type) {
      ProcessMaker.apiClient
        ...
        .then((response) => {
          const groups = response.data.data.map((item) => ({
            id: `group-${item.id}`,
            fullname: item.name,
          }));
          this.usersAndGroups = [];
    ...
    onAssignmentSave() {
      ProcessMaker.apiClient.post(
        `/processes/${this.processId}/import/assignments`,
        {
