...
<script>
  import {VueFormBuilder, VueFormRenderer} from "@processmaker/processmaker-screen-builder";
  import ComputedProperties from "@processmaker/processmaker-screen-builder/src/components/computed-properties";
  import CustomCSS from "@processmaker/processmaker-screen-builder/src/components/custom-css";
