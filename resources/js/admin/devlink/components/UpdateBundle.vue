<script setup>
import {
  ref, computed, getCurrentInstance, defineEmits, defineExpose,
} from "vue";
        ...
        <b-form-group v-if="!reinstall">
          ...
          >
            <b-form-radio value="update">
              ...
              <p class="text-muted">
                {{ $t('Existing assets on this instance will be updated. Warning: this will overwrite any changes you made to the assets on this instance.') }}
              </p>
            </b-form-radio>
            ...
            <b-form-radio value="copy">
              ...
              <p class="text-muted">
                {{ $t('Create new copies of bundle assets.') }}
              </p>
            </b-form-radio>
          </b-form-radio-group>
        </b-form-group>
