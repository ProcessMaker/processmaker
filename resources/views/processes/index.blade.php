		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group">
					...
					{!!Form::select('process_category_uuid', $processCategories, null, ['class'=> 'form-control', 'v-model'=>
					'categoryOptions', 'v-bind:class' => '{\'form-control\':true, \'is-invalid\':addError.process_category_uuid}'])!!}
					<div class="invalid-feedback" v-for="category in addError.process_category_uuid">@{{category}}</div>
				</div>
				<div class="form-group">
					{!!Form::label('status', 'Status');!!}
					{!!Form::select('status', [''=>'Select','ACTIVE'=> 'Active', 'INACTIVE'=> 'Inactive'], null, ['class'=>
					'form-control', 'v-model'=> 'status', 'v-bind:class' => '{\'form-control\':true,
					\'is-invalid\':addError.status}'])!!}
