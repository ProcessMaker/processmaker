        ...
        <div class="row">
            ...
            <div class="col-8" align="right">
                @can('import-processes')
                    <a href="#" id="import-process" class="btn btn-outline-secondary" @click="goToImport"><i class="fas fa-file-import"></i>
                        {{__('Import')}}</a>
                @endcan
                @can('create-processes')
                    <a href="#" id="create-process" class="btn btn-secondary" data-toggle="modal" data-target="#addProcess"><i
                                class="fas fa-plus"></i>
                        {{__('Process')}}</a>
                @endcan
            </div>
