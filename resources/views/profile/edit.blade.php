...
@section('content')
    <div id="profile-edit" :user-id="{{ \Auth::user()->id }}">
        <container v-cloak v-if="user">
            <container-page parent active link-text="Edit User Profile" :header="`Edit User Profile: ${user.fullname}`"></container-page>
            ...
            <container-page parent header="Administration"></container-page>
