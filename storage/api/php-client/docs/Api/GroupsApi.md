...
------------- | ------------- | -------------
[**createGroup**](GroupsApi.md#createGroup) | **POST** /groups | Save a new groups
[**deleteGroup**](GroupsApi.md#deleteGroup) | **DELETE** /groups/groupId | Delete a group
[**getGroupById**](GroupsApi.md#getGroupById) | **GET** /groups/groupId | Get single group by ID
[**getGroups**](GroupsApi.md#getGroups) | **GET** /groups | Returns all groups that the user has access to
[**updateGroup**](GroupsApi.md#updateGroup) | **PUT** /groups/groupId | Update a group


# **createGroup**
> \OpenAPI\Client\Model\Groups createGroup($groups_editable)
...
$groups_editable = new \OpenAPI\Client\Model\GroupsEditable(); // \OpenAPI\Client\Model\GroupsEditable | 

try {
    $result = $apiInstance->createGroup($groups_editable);
    print_r($result);
} catch (Exception $e) {
...
------------- | ------------- | ------------- | -------------
 **groups_editable** | [**\OpenAPI\Client\Model\GroupsEditable**](../Model/GroupsEditable.md)|  |
...
# **deleteGroup**
> \OpenAPI\Client\Model\Groups deleteGroup($group_id)
...
# **getGroupById**
> \OpenAPI\Client\Model\Groups getGroupById($group_id)
...
try {
    $result = $apiInstance->getGroupById($group_id);
    print_r($result);
} catch (Exception $e) {
...
# **getGroups**
> \OpenAPI\Client\Model\InlineResponse2005 getGroups($filter, $order_by, $order_direction, $per_page, $include)
...
try {
    $result = $apiInstance->getGroups($filter, $order_by, $order_direction, $per_page, $include);
    print_r($result);
} catch (Exception $e) {
...
# **updateGroup**
> \OpenAPI\Client\Model\Groups updateGroup($group_id, $groups_editable)
...
try {
    $result = $apiInstance->updateGroup($group_id, $groups_editable);
    print_r($result);
} catch (Exception $e) {
