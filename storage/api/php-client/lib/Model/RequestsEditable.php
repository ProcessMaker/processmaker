...
/**
 * RequestsEditable Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class RequestsEditable implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'requestsEditable';
     ...
     * Sets name
     *
     * @param string|null $name Represents an Eloquent model of a Request which is an instance of a Process.
     *
     * @return $this
     */
